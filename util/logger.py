...
import os.path
# from utils import SafeFileHandler
...
# rf_handler = ConcurrentRotatingFileHandler(os.path.join(loggerPath,"all.log"),maxBytes=10*1024*1024,backupCount=10,encoding='utf8')
rf_handler.setFormatter(fmt)

err_handle = logging.handlers.RotatingFileHandler(os.path.join(loggerPath,'error.log'))
